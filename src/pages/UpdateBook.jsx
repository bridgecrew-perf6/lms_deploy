...
import { updateBook, reset, setEdit } from '../features/books/bookSlice'
...
const { books, isLoading, isError,isSuccess, message, setEdit,editedData } = useSelector(
  (state) => state.books
)
console.log(books)
console.log(oldId.id)
const oldBook = books.filter(function(b)
  {return b.id== oldId.id}
)
